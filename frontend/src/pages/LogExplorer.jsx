...
import { Terminal, Search, Filter, Play, Pause, ChevronDown, ChevronRight, FileJson, AlertCircle } from 'lucide-react';
                 ...
                 filteredLogs.map((log) => (
                   <React.Fragment key={log.id}>
                     ...
                     >
                       ...
                       <td className="p-3 text-purple-400">{log.source}</td>
